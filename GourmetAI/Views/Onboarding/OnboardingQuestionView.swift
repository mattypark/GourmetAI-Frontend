...
struct OnboardingQuestionView: View {
    ...
    private var questionContent: some View {
        ...
        case 16:
            ...
            HealthKitOnboardingView(selection: $viewModel.enableHealthKitSync)
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                benefitRow(icon: "arrow.triangle.2.circlepath", text: "Sync weight & height automatically")
                benefitRow(icon: "flame.fill", text: "Track calories burned from workouts")
                benefitRow(icon: "fork.knife", text: "Log meals directly to Apple Health")
                benefitRow(icon: "chart.line.uptrend.xyaxis", text: "Monitor your nutrition progress")
            }
